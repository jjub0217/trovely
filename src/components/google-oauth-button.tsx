  ...
  return (
    <div className="w-full">
      <button
        ...
        onClick={handleClick}
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 py-3 rounded-xl text-sm font-semibold disabled:opacity-50 hover:bg-gray-100 transition-colors"
      >
        <GoogleIcon />
